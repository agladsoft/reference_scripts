...
xls_path="${XL_IDP_PATH_REFERENCE}/reference_report_on_order/"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_PATH_REFERENCE_SCRIPTS}/scripts_for_bash_with_inheritance/reference_report_on_order.py "${csv_name}" "${json_path}"

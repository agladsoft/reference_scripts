...
xls_path="${XL_IDP_PATH_REFERENCE}/reference_inn_by_api/"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_PATH_REFERENCE_SCRIPTS}/scripts_for_bash_with_inheritance/reference_inn_by_api.py "${csv_name}" "${json_path}"
